...
public class ValidateProfileRequestExecutorTest {
    @Test
    public void shouldBarfWhenUnknownKeysArePassed() throws Exception {
        ValidateProfileRequestExecutor executor = new ValidateProfileRequestExecutor(new ValidateProfileRequest(Collections.singletonMap("foo", "bar")));
    ...
    public void shouldValidateMandatoryKeys() throws Exception {
        ValidateProfileRequestExecutor executor = new ValidateProfileRequestExecutor(new ValidateProfileRequest(Collections.<String, String>emptyMap()));
        String json = executor.execute().responseBody();
